...
export default async function Nav() {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-border bg-surface/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl flex-col gap-y-2 px-4 py-2.5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-6 sm:px-6">
        <Link href="/" className="focus-ring flex shrink-0 items-center self-start rounded-lg py-1">
